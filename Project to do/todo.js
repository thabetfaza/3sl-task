const todoInput = document.getElementById('todoInput');
    ...
    const renderTasks = () => {
      ...
      if (filteredTasks.length === 0) {
        todoList.innerHTML = '<p style="color: #888; font-style: italic;">No tasks.</p>';
        return;
      }
    ...
    const updateDeleteButtons = () => {
      ...
      deleteDoneTasksButton.disabled = !completedTasks;
      deleteAllTasksButton.disabled = !allTasks;
    };
    ...
    deleteDoneTasksButton.addEventListener('click', () => {
      ...
      if (completedTasks.length === 0) {
        showErrorMessage('No completed tasks to delete.');
        return;
      }
